function slider({ container, slide, nextArrow, prevArrow, totalCounter, currentArrow, wrapper, field}) {

    // Slider

    const slides = document.querySelectorAll(slide),                  // Получение данных слайдера
          slider = document.querySelector(container),
          prev = document.querySelector(prevArrow),
          next = document.querySelector(nextArrow),
          total = document.querySelector(totalCounter),
          current = document.querySelector(currentArrow),
